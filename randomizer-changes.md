...
- If you enabled the Randomize Settings option, the locations that cannot have progression items can be found by talking to Gaepora in the Academy. The maximum number of crystals that batreaux can potentially give progression items for can be found by talking to the Old Man in Lumpy Pumpkin (You can select any of his three text options).
## Goal
